...
# 2. THE EXPANDED DATA FEED (Multi-Vendor Catalog)
scraped_parts = [
    # CPUs
...
print("Starting automated database sync. Injecting multi-vendor catalog...")
...
for part in scraped_parts:
    ...
    print(f"✅ Synced: {part['name']} - ₱{part['price']} (Source: {part['vendor']})")

print("🚀 Multi-vendor database sync complete! Aggregator feeds are now live.")